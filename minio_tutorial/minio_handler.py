...
class MinioHandler():
    ...
    def make_bucket(self) -> str: #tạo bucket trên minio
        if not self.client.bucket_exists(self.bucket_name):
            self.client.make_bucket(self.bucket_name)
        return self.bucket_name

    def presigned_get_object(self, bucket_name, object_name): #để get file url khi đã push lên minio
    ...
    def put_object(self, file_data, file_name, content_type): # để push file lên Minio
        try:
